...
Feature: Registration Page
  ...
  Scenario: Register with Valid Scenario
    Given User Launch The Chrome Browser
    When User Open URL "http://onlinegamblingtech.com/registration"
    When Enter FirstName as "new", Lastname as "test", Email as "newtest6@yopmail.com", Dateofbirth as "08121989", phone as "8568568556", username as "newtest06" , password as "Test@1234" and accept T&C
    And Click on register button
