...
@BetInPrime
Feature: To chekc the profile functionality
  ...
  Scenario: Check profile page displayed pasting direct link
    Given User Launch The Chrome Browser
  ...
  Scenario: - Check the update profile information
    ...
    And Click Update profile button
    Then verify the update profile update toast message as "Your profile updated successfully."
    And close the browser
  ...
  Scenario: - Checking the password change functionality
    ...
    And Click Update profile button
    Then Verify the password success toast message as "Your profile updated successfully."
    And close the browser
